...
void	ft_init_img_bis(t_map *map)
{
	...
	map->add_img->player_down = mlx_xpm_file_to_image(map->mlx, path, &width, &height);
	path = "./img_final/left.xpm";
	map->add_img->player_left = mlx_xpm_file_to_image(map->mlx, path, &width, &height);
	path = "./img_final/right.xpm";
	map->add_img->player_right = mlx_xpm_file_to_image(map->mlx, path, &width, &height);
	path = "./img_final/up.xpm";
	map->add_img->player_up = mlx_xpm_file_to_image(map->mlx, path, &width, &height);
}
